    ...
    <header class="fixed w-full bg-white md:bg-white/80 backdrop-blur-sm z-50 border-b border-gray-100">
        <nav class="container mx-auto px-4 py-4 flex items-center justify-between">
            ...
            <div class="hidden md:flex items-center gap-6">
                ...
                <a href="https://github.com/laravelstart/laravelstart" target="_blank" class="fill-gray-600 hover:fill-gray-900" title="Github">
                ...
                <a href="https://discord.gg/XdUbDdkU" target="_blank" class="fill-gray-600 hover:fill-gray-900" title="Github">
